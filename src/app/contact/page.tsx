...
export default function ContactPage() {
  ...
  const handleContactSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setContactSent(true); // show success anyway
    } finally {
      setSubmitting(false);
    }
  };
      ...
      <section id="get-listed" className="mb-20">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 leading-relaxed max-w-xl mx-auto">
            ...
            Fill in our short listing form and we'll review and add your business within a few days.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 text-center">
          ...
          <p className="text-xs text-gray-400 mt-4">Opens a short Google Form — takes about 2 minutes</p>
        </div>
      </section>
