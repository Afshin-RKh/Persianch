    ...
    <main className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
      ...
      <section id="get-listed" className="mb-20">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 leading-relaxed max-w-xl mx-auto">
            Are you Persian, Afghan, or Tajik — running a business where your language, culture, and cuisine make a real difference for your audience? We'd love to feature you on PersianHub — for free.
      ...
      <section id="contact">
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl font-bold mt-3 mb-3" style={{ color: "#1B3A6B" }}>
            Get in Touch
          </h2>
          <p className="text-gray-600 leading-relaxed max-w-xl mx-auto">
        ...
        {contactSent ? (
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-10 text-center">
            ...
            <h3 className="text-xl font-bold mt-4 mb-2" style={{ color: "#1B3A6B" }}>Message received!</h3>
