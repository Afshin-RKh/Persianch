  ...
  if (!business) {
    return (
      <main className="max-w-4xl mx-auto px-4 py-20 text-center text-gray-500">
        ...
        <Link href="/businesses" className="text-red-600 hover:underline mt-4 inline-block">
          ← Back to listings
        </Link>
      </main>
    );
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="h-56 bg-gradient-to-br from-red-50 to-rose-100 flex items-center justify-center">
          {business.image_url ? (
        ...
        <div className="p-6 sm:p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6 pt-6 border-t border-gray-100">
            ...
            {business.website && (
              <div className="flex items-start gap-2.5">
                <Globe size={18} className="text-red-600 mt-0.5 shrink-0" />
                <div>
